...
export default async function Index() {
  ...
  return (
    <main>
      ...
      <CategoryCarousel />
      <BestSellingProducts />
      <section id="latest-blog" className="pb-4 my-8 md:my-12"> {/* Added margin */}
        <div className="container mx-auto px-4 lg:px-8">
          {/* Section Header */}
          <div className="flex items-center justify-between my-4 mb-8"> {/* Increased bottom margin */}
            <h2 className="text-3xl font-bold text-dark">Our Recent Blog</h2>
            <Link href="/blog" className="bg-primary text-white hover:bg-orange-500 px-5 py-2 rounded text-sm font-semibold transition-colors duration-300">
              View All
            </Link>
          </div>
          {/* Blog Grid */}
